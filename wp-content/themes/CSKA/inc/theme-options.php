<?php
	...
	function fill_primer_field1(){
		...
		?>
		<input type="text" name="settings[phone1]" value="<?php echo esc_attr( $val ) ?>" />
		<?php
	}
	/*
	## Заполняем опцию 2
	function fill_primer_field2(){
		...
		?>
		<input type="text" name="settings[phone2]" value="<?php echo esc_attr( $val ) ?>" />
		<?php
	}
	## Заполняем опцию 3
	...
	function fill_primer_field4(){
		...
		?>
		<input type="email" name="settings[email]" value="<?php echo esc_attr( $val ) ?>" />
		<?php
	}
	...
	function fill_primer_field5(){
		...
		?>
		<input type="text" name="settings[address]" value="<?php echo esc_attr( $val ) ?>" />
		<?php
	}
	/*
	## Заполняем опцию 6
	function fill_primer_field6(){
		...
		$val = $val ? $val['fb'] : null;
		?>
		<input type="text" name="settings[fb]" value="<?php echo esc_attr( $val ) ?>" />
		<?php
	}
	...
	function fill_primer_field7(){
		...
		?>
		<input type="text" name="settings[inst]" value="<?php echo esc_attr( $val ) ?>" />
		<?php
	}
	...
	function fill_primer_field9(){
		...
		?>
		<input type="text" name="settings[work-time]" value="<?php echo esc_attr( $val ) ?>" />
		<?php
	}
	/*
	## Заполняем опцию 10
