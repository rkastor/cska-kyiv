 ...
 */
abstract class PSP_Models_Abstract_Domain implements ArrayAccess {
    ...
    protected function _getProperties() {
        ...
        if (true) {
            ...
            // match the pattern [_property:protected]
            $matches = null;
            preg_match_all('/^\s+\[_(\w+):protected\]/m', $dump, $matches);
            // extract the properties
            $vars = $matches[1];
            // build properties array
            foreach ($vars as $var)
                $properties[$var] = $this->$var;
        }
