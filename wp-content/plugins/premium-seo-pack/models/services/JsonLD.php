...
class PSP_Models_Services_JsonLD extends PSP_Models_Abstract_Seo {
    ...
    public function __construct() {
        ...
        if ($this->_post->psp->doseo) {
            if (class_exists('WooCommerce')) {
                ...
                add_filter('psp_json_ld', array($this, 'generate_breadcrumblist_data_blog'), 9);
            }
            add_filter('psp_json_ld', array($this, 'generate_structured_data_blog'), 9);
    ...
    public function generate_structured_data_blog() {
        ...
        if ($this->_post->post_type == 'home') {
        ...
        } elseif ($this->_post->post_type == 'post') {
            ...
            if (isset($this->_post->psp->og_media) && $this->_post->psp->og_media <> '') {
